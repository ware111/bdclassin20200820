    ...
    <bbData:context id="ctx">
        <bbNG:jsBlock>
            ...
            <script type="text/javascript">
                ...
                jQuery.ajax({
                    type: "GET",
                    url: "/webapps/bb-ClassIn-BBLEARN/classinCourseClass/getDefaultValue.do",
                    ...
                    <div style="margin-left: 3%">
                        <div class="row" style="margin-top:20px;">
                            <div class="col-sm-2" style="width: 10%;">
                                <span style="line-height:34px;width:100%;">教室名称</span>
                            </div>
                            <div class="col-sm-3" style="padding-left:10px;">
                                <input type="text" name="className" value="" id="className"
                                       style="height: 34px;width:100%;" onblur="checkClassRoom()">
                            </div>
                        ...
                        <div class="row" style="margin-top:20px;margin-bottom:20px;">
                            ...
                            <div class="col-sm-3" style="padding-left:10px;">
                                <select id="classType" style="width:100%;">
                                    <option value="课节课">课节课</option>
                                    <option value="非课节课" selected="selected">非课节课</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class='col-sm-3' style="padding-left:10px;">
                                <div>
                                    <select id="hour" onblur="computeOverTime()" style="float: left;width:40%;">
                                ...
                                <div>
                                    <select id="minute" onblur="computeOverTime()" style="float: left;width:40%;">
