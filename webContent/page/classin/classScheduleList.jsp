        ...
        <bbNG:jsBlock>
            <SCRIPT type="text/javascript">
                ...
                function editTeacher(classId) {
                    ...
                    var teacherInfo = teacher;
                    if (confirm("确认更换授课教师？")) {
                        window.location.href = "${pageContext.request.contextPath}/classinCourseClass/editClassTeacher.do?classId=" + classId + "&teacherInfo=" + teacherInfo + "&course_id=" + course_id;
                    }
                }
                ...
                function addAssistant(classId) {
                    ...
                    assistantInfo = assistantTeacher;
                    if (confirm("确认添加助教？")) {
                        window.location.href = "${pageContext.request.contextPath}/classinCourseClass/editClassTeacher.do?classId=" + classId + "&teacherInfo=" + teacherInfo + "&assistantInfo=" + assistantInfo + "&course_id=" + course_id;
                    }
                }
