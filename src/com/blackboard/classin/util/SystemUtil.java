...
//		System.out.println(vDurationMin);
	...
	//获取Bb下老师
	public static List<BBUser> getBbTeachers(String courseId,UserPhoneMapper userPhoneMapper) throws PersistenceException {
    ...
    //获取Bb下助教
    public static List<BBUser> getBbAssistantTeachers(String courseId,UserPhoneMapper userPhoneMapper) throws PersistenceException {
        CourseMembershipDbLoader courseMembershipDbLoader  =CourseMembershipDbLoader.Default.getInstance();
