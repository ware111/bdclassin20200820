...
public class UserPhoneController {
    ...
    public String bindPhone(HttpServletRequest request, HttpServletResponse response, String course_id, String type, Model model) throws PersistenceException, JsonParseException, JsonMappingException, IOException {
        ...
        log.info("courseNme:" + course.getTitle());
        //查找手机号
        ...
        if (userPhone != null) {
            ...
            if (classinUid == null || "".equals(classinUid)) {
                ...
                String classin_register_url = "https://api.eeo.cn/partner/api/course.api.php?action=register";
...
//        		bbSession.setGlobalKey("role","teacher");
//        		//教师-->可以创建classin课程
//        		//return "/classin/createClassinClass";
//				return "redirect:/classinCourseClass/getHomeClassList.do?course_id="+course_id;
//        	}else{
//        		//学生,去查询有无在线课堂
//        		bbSession.setGlobalKey("role","student");
//        		return "redirect:/bbCourseClassinCourse/findClass.do?course_id="+course_id+"&type="+type;
//        	}
        } else {
            //用户未绑定手机号，需要初始化
            model.addAttribute("type", type);
